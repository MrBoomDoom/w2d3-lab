...
const diddly = (parameter1, parameter2) => {
    return `The first parameter is ${parameter1} The second parameter is ${parameter2}.`
}

// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.

console.log(diddly('toyota', 'corrolla'))
...
greeting('Todd', 'Turner', (fullName) => console.log(`Hello, my full name is ${fullName} `))
